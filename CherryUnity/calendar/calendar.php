                ...
                <div class="col-md-offset-2  col-md-4">
                    ...
                    <div class="filesToAdd none">
                        ...
                        foreach ($files as $file) {
                            echo '<div class="col-md-8" > <div class="input-group">  <input type="text" class="datepicker form-control" placeholder="Choisir une date" aria-describedby="basic-addon2"><span class="input-group-addon" id="basic-addon2">Date de fin</span></div> </div>'
                       ...
                       <br/>
                        ...
                        <button class="btn btn-default">Ajouter les fichiers à l'enfant</button>
                    </div>
...
>>>>>>> 9d1bc2cb0a4f442a96d15ddf9dc01efd2a529dd0
