...
<?php
 ...
 /*       $ds = DIRECTORY_SEPARATOR;
    ...
    //    echo move_uploaded_file($_FILES['files']['tmp_name'][$i], $targetFile);// $path);
        ...
        move_uploaded_file($_FILES['files']['tmp_name'][$i], "C:\\xampp\\htdocs\\PhpProject_test\\uploads\\".$_FILES['files']['name'][$i] );
        $url = "http://localhost/PhpProject_test/uploads/".$_FILES['files']['name'][$i];
        //echo '       !!! test !!!  -'.$url.'_        ';
